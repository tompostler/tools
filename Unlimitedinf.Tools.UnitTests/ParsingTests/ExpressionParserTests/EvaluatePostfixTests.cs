...
namespace Unlimitedinf.Tools.UnitTests.ParsingTests.ExpressionParserTests
{
    ...
    public class EvaluatePostfixTests
    {
        ...
        {
            double expected = 7;
            var input = new List<string>{ "3", "4", "+" };
            var actual = ExpressionParser.EvaluatePostfix(input);
        ...
        public void WikipediaTest1_Mod()
        {
            ...
            var input = new List<string>{ "30", "40.2", "+" };
            var actual = ExpressionParser.EvaluatePostfix(input);
        ...
        public void WikipediaTest2()
        {
            ...
            var input = new List<string>{ "3", "4", "2", "*", "1", "5", "-", "2", "3", "^", "^", "/", "+" };
            var actual = ExpressionParser.EvaluatePostfix(input);
        ...
        {
            double expected = 5.2;
            var input = new List<string>{ "2", "3", "*", "4", "5", "/", "-" };
            var actual = ExpressionParser.EvaluatePostfix(input);
